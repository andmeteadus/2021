...
**Esimese variandi** puhul andmete R-i importimiseks ja vajalike tunnuste eraldamiseks toimi järgmiselt:
...
ESS <- import_country('Estonia', rounds = 9, ess_email = '<sinu ESS registreeritud e-post>') %>% 
