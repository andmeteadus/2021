...
**Kodutöö esitamiseks lae alla [Jupyter Notebook fail ja abifail](../data/kodutoo1.zip).**
...
* I osa ja II osa tuleb esitada vastused [Jupyter Notebook faili](../kodutood/kodutoo2.ipynb). 
* II osa kohta tee andmeanalüüsi raport R-is, Rmarkdown keeles, ning väljasta raport (html või pdf formaadis), salvesta .png formaati (nt. [pdf2png.com](pdf2png.com) abil) ja lisa Jupyter faili. Lähtekood .Rmd failis kopeeri Jupyter Notebook faili.
